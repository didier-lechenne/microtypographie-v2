...
export class SmartQuotes extends BaseFixer {
  ...
  private fixFrenchQuotes(text: string): string {
    ...
    // Transformer << et >> en guillemets français si activé
    ...
    // Transformer les apostrophes droites restantes en apostrophes typographiques
